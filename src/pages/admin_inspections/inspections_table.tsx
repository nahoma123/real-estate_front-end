...
export default function UpcomingInspectionsTable() {
  ...
  return (
    <Box minHeight={"500px"} width={"100%"} margin={"0px 0px"} display={"flex"} flexDirection={"column"} >
        ...
        <Table aria-label="customized table">
          ...
          >
            <TableRow>
              ...
              <StyledTableCell align="center">Inspected?</StyledTableCell>
          ...
          <TableBody>
            {properties?.map((row) => (
              <StyledTableRow key={row.created_at}>
                ...
                <StyledTableCell align="center">
                  {formatTime(row.next_inspection_date)}
                </StyledTableCell>
                <StyledTableCell align="center">
                  {row.inspected ? (
                    <Typography color={"green"}>Inspected</Typography>
                  ) : (
                    <Typography color={"red"}>Not Inspected</Typography>
                  )}
                </StyledTableCell>
                ...
                <StyledTableCell align="center">
                  <Button
                    variant="outlined"
                    onClick={() =>
                      navigate(`/admin_dashboard/edit_properties/${row.id}`)
                    }
                  >
                    Update
                  </Button>
