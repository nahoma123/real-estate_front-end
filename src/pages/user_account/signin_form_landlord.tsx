...
import { loginUser_Landlord } from "../../services/apiService";
...
const LoginFormLandLord: React.FC = () => {
  const {
    handleSubmit,
    control,
  ...
  const onSubmit = handleSubmit(async (data:any) => {
    try {
      ...
      const responseData = await loginUser_Landlord(data?.email, data?.password);
