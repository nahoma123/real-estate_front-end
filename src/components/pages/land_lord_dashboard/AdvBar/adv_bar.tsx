...
const BlockBar: React.FC = () => {
  ...
  return (
    <Bar marginTop={2} marginBottom={2} className="sm:pl-5 sm:pr-5 md:pl-10 md:pr-10 lg:pl-20 lg:pr-20">
      <Grid container>
        ...
        <Grid md={10} xs={12} sm={12} lg={10}>
          <LogoContainer>
            ...
            <Logo src={SpareRoom} alt="SpareRoom" className="mb-2 sm:mb-0" />
            <TrustpilotLink
            ...
            >
              <Logo src={TrustPilot} alt="TrustPilot" className="mr-2" />
              <Rating
